...
const WalletIntroSVG = () => (
  <svg width="198" height="178" viewBox="0 0 198 178" fill="none" xmlns="http://www.w3.org/2000/svg">
    <rect x="24" y="48" width="150" height="90" rx="16" fill="#4F8DFD" />
    <rect x="32" y="56" width="134" height="74" rx="12" fill="#fff" fillOpacity="0.95" />
    <rect x="44" y="68" width="110" height="50" rx="8" fill="#E3EFFF" />
    <circle cx="150" cy="60" r="18" fill="#FFD600" stroke="#F7B500" strokeWidth="4" />
    <circle cx="160" cy="50" r="8" fill="#FFD600" stroke="#F7B500" strokeWidth="2" />
    <rect x="60" y="90" width="40" height="12" rx="6" fill="#4F8DFD" fillOpacity="0.7" />
    <ellipse cx="60" cy="130" rx="10" ry="6" fill="#FFD600" fillOpacity="0.7" />
    <ellipse cx="80" cy="140" rx="8" ry="5" fill="#FFD600" fillOpacity="0.5" />
  </svg>
)
